...
export default function PrimaryAmmoIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1434 1024" aria-hidden focusable="false" {...props}>
