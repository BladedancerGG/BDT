...
export default function SpecialAmmoIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1434 1024" aria-hidden fill="#7af48b" focusable="false" {...props}>
